...
export const LandingPage: React.FC = () => {
  ...
  return (
  <section className="max-h-[100dvh] h-[100dvh]">
      <video
        autoPlay
        loop
        muted
     ...
     <img src="/Josefine-ostlund-w-50.svg" alt="josefine östlund" className="absolute z-20 bottom-2 right-1 max-w-[98%] laptop:max-w-[40%] laptop:bottom-5 laptop:right-5"/>
    </section>
  )
}
