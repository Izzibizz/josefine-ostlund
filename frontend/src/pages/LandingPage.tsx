...
export const LandingPage: React.FC = () => {
  ...
  <section>
     ...
     <img src="/Josefine-ostlund-w-50.svg" alt="josefine östlund" className="absolute z-28 bottom-20 tablet:bottom-2 right-1 max-w-[98%] laptop:max-w-[40%] laptop:bottom-5 laptop:right-5"/>
    </section>
  )
}
